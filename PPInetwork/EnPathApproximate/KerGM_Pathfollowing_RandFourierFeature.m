function [OptX,obj] = KerGM_Pathfollowing_RandFourierFeature(Adj1,Adj2,lambda,num,Para,time)
...
% Approximate Edge Features
[EdgeFeat1,EdgeFeat2,AA,BB]=RandomFourierFeatureForPPI(Adj1,Adj2,Para,time);
...
for i=1:num
    ...
    if obj>val
        [Xnew,val]=EntropyWF(0.5,Xnew,lambda,1000); 
        fprintf('happens\n');
    end
    obj=val;
...
GradOpt=Gradient_alpha05(X,EdgeFeat1,EdgeFeat2);

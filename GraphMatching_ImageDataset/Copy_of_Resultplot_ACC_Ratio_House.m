...
lp = get(lgd, 'Position');
% center top
set(lgd, 'Position', [ap(1)-0.16 ap(2)+ap(4)+0.015 lp(3) lp(4)*0.75], 'FontSize', 16);
hold off;
...
set(gcf, 'Position', [10 10 1100 700]);
...
s = 0.15;
h = 0.13;
annotation('textbox',[s h+0.48 0.105 0.06],'String','(20, 30)', 'FontSize', 17);
annotation('textbox',[s+0.44 h+0.48 0.105 0.06],'String','(20, 30)', 'FontSize', 17);
annotation('textbox',[s h 0.105 0.06],'String','(30, 30)', 'FontSize', 17);
annotation('textbox',[s+0.44 h 0.105 0.06],'String','(30, 30)', 'FontSize', 17);
